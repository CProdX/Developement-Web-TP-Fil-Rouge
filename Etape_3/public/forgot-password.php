...
renderHeader('Mot de passe oublie', 'MOT DE PASSE OUBLIE');
?>
<main class="centrer-flex">
    <div class="cadre largeur-login">
        <h2 class="titre-formulaire">Recuperation</h2>
        ...
        <form method="post" action="<?= e(url('actions/forgot_password.php')) ?>">
